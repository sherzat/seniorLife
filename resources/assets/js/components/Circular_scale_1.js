...
class Circular_scale_1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            rotate_degree: "rotate(-18 350,332.91281127929693)" ,
        };
	...
	render() {
        return (
            <div className="menu-wrapper">
                <svg viewBox="0 0 700 380" id="menu" preserveAspectRatio="xMinYMin meet" className="svg-content" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <title>Layer 1</title>
                        <g id="symbolsContainer">
                            <symbol viewBox="0 0 69 69" id="icon-1" className="icon icon-">
                                <text id="svg_2" fontSize="26px" textAnchor="middle" y="-60%" x="50%" fill="#222">{this.props.choices[0]}</text>
                                <g>
                                    <path
                            ...
                            <symbol viewBox="0 0 69 69" id="icon-2" className="icon icon-">
                                <text id="svg_4" fontSize="26px" textAnchor="middle" y="-60%" x="50%" fill="#222">{this.props.choices[1]}</text>
                                <g>
                                    <path
                                        fill="#FFFFFF"
                            ...
                            <symbol viewBox="0 0 69 69" id="icon-3" className="icon icon-">
                                <text id="svg_6" fontSize="26px" textAnchor="middle" y="-60%" x="50%" fill="#222">{this.props.choices[2]}</text>
                                <g fill="#1D1D1B">
                                    <path
                                        fill="#FFFFFF"
                                        d="M32,0C14.355,0,0,14.355,0,32s14.355,32,32,32s32-14.355,32-32S49.645,0,32,0z M32,60    C16.561,60,4,47.439,4,32S16.561,4,32,4s28,12.561,28,28S47.439,60,32,60z" 
                            ...
                            <symbol viewBox="0 0 69 69" id="icon-4" className="icon icon-">
                                <text id="svg_8" fontSize="26px" textAnchor="middle" y="-60%" x="50%" fill="#222">{this.props.choices[3]}</text>
                                <g fill="#1D1D1B">
                                    <path
                                        fill="#FFFFFF"
                                        d="M32,0C14.355,0,0,14.355,0,32s14.355,32,32,32s32-14.355,32-32S49.645,0,32,0z M32,60    C16.561,60,4,47.439,4,32S16.561,4,32,4s28,12.561,28,28S47.439,60,32,60z" 
