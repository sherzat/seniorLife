                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="symbolsContainer">
                            <symbol className="icon icon-" id="icon-1" viewBox="0 0 69 69">
                                ...
                                <text fill="#222" x="50%" y="50%" dy=".3em" textAnchor="middle" fontSize="1.2em">2222</text>
                            </symbol>

                            <symbol className="icon icon-" id="icon-2" viewBox="0 0 69 69">
                                <rect fill="none" stroke="#111" strokeWidth="1" width="100%" height="100%"></rect>
                                <text fill="#222" x="50%" y="50%" dy=".3em" textAnchor="middle" fontSize="1.2em">what2</text>
                            </symbol>
                        ...
                        <g id="itemsContainer">
                            <a className="item" id="item-1" role="button" tabIndex="0" onClick={this.handleClick} title=" " transform="matrix(1,0,0,1,0,0)" data-svg-origin="250 250" >
                                ...
                                <use href="#Port"  x="405.7113037109375" y="153.6966094970703" transform="rotate(72 440.2113037109375 188.1966094970703)"></use>
                                <p>{this.props.choices[0]}</p>
                            </a>
