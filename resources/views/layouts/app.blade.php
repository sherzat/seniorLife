...
<div class="container-fluid">
    <nav class="navbar navbar-light Inlining-listing bg-faded nav-customize dropdown">
        ...
        <button class="navbar-toggler navbar-toggler-right m-2 Bar-cloud hidden-lg-up" type="button"
                data-toggle="dropdown"
                id="navbarDropdownMenuLink" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
        ...
        <div class="dropdown-menu dropdown-menu-right p-2 hidden-sm-down" aria-labelledby="navbarDropdownMenuLink2">
            ...
            <button class="dropdown-item list-group-item border-0 pt-2 pb-2" href="#"><a  class="mr-auto">User stats</a>
            ...
            <div class="dropdown-divider"></div>
            <button class="dropdown-item list-group-item border-0 pt-2 pb-2" href="{{ url('/logout') }}" onclick="event.preventDefault();
                                                                 document.getElementById('logout-form').submit();"><a class="mr-auto">Sign Out</a>
