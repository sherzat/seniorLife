                ...
                <a href="#">
                    <div class="card-block">
                        <fieldset>
                            ...
                            <img class="card-img-top img-responsive" src="img/Share.png" width="150" height="150"
                                 align="left"/>

                            <!-- settings-for-paragraphs are found in _home_footor_settings -->
                            <!-- text-color-paragraphs changes the color of the paragraph -->
                            <p class="card-text text-color-paragraphs settins-for-paragraphs lead">By sharing your
                    ...
                    <div class="card-block">
                        <fieldset>
                            ...
                            <img class="card-img-top img-responsive" src="img/Empatica.png" width="150" height="150"
                                 align="left"/>
                            <p class="card-text text-color-paragraphs settins-for-paragraphs lead">Empatica is a
                ...
                <a href="#">
                    <div class="card-block">
                        <fieldset>
                            ...
                            <img class="card-img-top img-responsive" src="img/Survey.png" alt="" width="150"
                                 height="150"
                                 align="left"/>
                            <p class="card-text text-color-paragraphs settins-for-paragraphs lead">In Survey part, you
                                will find different
                                categories and
